...
usage() {
    echo "Usage:"
    echo "$0 {path to extracted file system of firmware} {optional: name of the file to store results - defaults to firmwalker.txt}"
...
getArray() {
    array="" # Initialize as an empty string
...
do
    ...
    do
        if [ "${certfile##*.}" = "pem" ] || [ "${certfile##*.}" = "crt" ]; then
